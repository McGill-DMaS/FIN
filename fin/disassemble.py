# This file contains code from the Kam1n0-Community project.
# Source: https://github.com/McGill-DMaS/Kam1n0-Community
...
for seg_ea in Segments():
    ...
    for function_ea in Functions(get_segm_start(seg_ea), get_segm_end(seg_ea)):#Functions(SegStart(seg_ea), SegEnd(seg_ea)):
        ...
        #if f_name == "main" or f_name.startswith('.'):
        #    continue
